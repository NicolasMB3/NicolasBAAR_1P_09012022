  ...
  interact('.resize-drag').resizable({
    ...
    listeners: {
      move(event) {
        ...
        target.style.height = 100 * event.rect.height / window.innerHeight + 'vh'; // translate when resizing from top or left edges
...
function sendEmail() {
  ...
  emailjs.send('service_a80h2ni', 'template_766uk3r', templateParams).then(function (response) {
